...
static std::string generateEagerCode(FOperationType operation, FType res_type,
  ...
  switch (operation) {
    ...
    case FGRADIENT_CONVOLVE: {
                               ...
                               code += ", const long num_entries1, const int dimensions1, const int dimensions0";
  ...
  switch (operation) {
    ...
    case FGRADIENT_CONVOLVE:
                 code +=
                   ...
                   "   long dk = (d == 0 ? k : k % acc_sizes_kernel[d - 1]) / acc_sizes_kernel[d];\n"
                   "   long di = (d == 0 ? index : index % acc_sizes_pred[d - 1]) / acc_sizes_pred[d];\n"
