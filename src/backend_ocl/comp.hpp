...
struct OCLCompilerThread {
		...
		//      - ONLY the compiler thread is allowed to compile code. This
		//      solves synchronizing problems with cache.
		//      - To do this we can insert in the queue at the back for "compile
